...
Elf64_Ehdr *Elf64::get_header() { return (Elf64_Ehdr *)m_mmap_program; }

void Elf64::print_header() {
  auto *header = get_header();
  printf("%d %d %d\n", header->e_type, header->e_machine, header->e_version);
}

#if 0
std::vector<section_t> Elf64::get_sections() {
...
std::vector<segment_t> Elf64::get_segments() {
  Elf64_Ehdr *ehdr = (Elf64_Ehdr *)m_mmap_program;
...
std::vector<symbol_t> Elf64::get_symbols() {
...
std::vector<relocation_t> Elf64::get_relocations() {
